...
class Config:
    ...
    # 组合配置文件路径（用户组合 / 观察名单）
    user_portfolio_path: str = "config/portfolio/user_portfolio.json"
    watchlist_path: str = "config/portfolio/watchlist.json"
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            user_portfolio_path=os.getenv('USER_PORTFOLIO_PATH', 'config/portfolio/user_portfolio.json'),
            watchlist_path=os.getenv('WATCHLIST_PATH', 'config/portfolio/watchlist.json'),
